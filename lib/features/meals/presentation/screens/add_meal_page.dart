...
import '../../data/mapper/meal_draft_mapper.dart';
                      ...
                      InkWell(
                        ...
                        onTap: () async {
                          final calculatedCarbs = await ref.read(
                            calculatedCarbsProvider.future,
                          );
                          ref
                          ...
                          final mealIngredientDrafts = ref.watch(
                          ...
                          for (final mealIngredient in mealIngredientDrafts) {
                            ...
                            final bothExisting =
                                mealIngredient.ingredient.maybeMap(
                                  existing: (_) => true,
                                  orElse: () => false,
                                ) &&
                                mealIngredient.ingredientPortion.portion
